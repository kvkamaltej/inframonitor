...
DEFAULT_ROLE_MENUS: dict[str, list[str]] = {
    "admin": ["dashboard", "servers", "shell", "users", "policies", "administration", "access", "appearance", "profile"],
    "developer": ["dashboard", "servers", "profile"],
    "support": ["dashboard", "servers", "profile"],
